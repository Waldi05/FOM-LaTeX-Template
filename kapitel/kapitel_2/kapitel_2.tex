...
umgegangen wird\footcite[Vgl.][o. S.]{Belastingdienst}.
...
Das funktioniert allerdings nicht, falls die Links zwischen Fußnote und Referenz im Text aktiviert sind. In diesem Fall werden die beiden Fußnoten schlichweg hintereinander aufgeführt. Es bietet sich hier dann an, mehrere Quellen in einer Fußnote unterzubringen.
Das ist mit \verb|~\footcites| möglich.~\footcites[\vglf][S. 20-40]{Liljegren2012}[][S. 55]{Balzert0.2008}
...
\textbf{Diese Formeln sind nicht nach FOM-Leitfaden! Siehe Formel \ref{Momentanreserve} auf Seite \pageref{Momentanreserve}.}
