...
%\floatsetup{capposition=top, justification=raggedright, captionskip=12pt}
\usepackage{array}
...
%\usepackage{inter}
\usepackage{fontspec}
\setmainfont{TeX Gyre Termes} % Helvetica Klon | Heros [Scale=0.9]
\setsansfont[Scale=0.9]{TeX Gyre Heros}
\setmonofont{Courier New}
\usepackage[mathrm=sym]{unicode-math}
%\setmathfont{XITS Math}
%\setmathfont{Latin Modern Math}
\setmathfont{TeX Gyre Termes Math} % Schola, Termes, Bonum, Pagella

\setkomafont{disposition}{\normalfont\rmfamily\bfseries\normalsize} % setzt Überschriften in Textgröße und Schriftart
...
\definecolor{bblue}{RGB}{0, 230, 220}
\definecolor{softblue}{RGB}{0, 190, 220}
\definecolor{softpurple}{RGB}{180, 168, 255}
\definecolor{siepurple}{RGB}{128, 92, 255}
\definecolor{dyellow}{RGB}{247, 198, 0}
\definecolor{yellow}{RGB}{255, 215, 50}
\definecolor{dsand}{RGB}{170, 170, 150}
\definecolor{ssand}{RGB}{197, 197, 184}
% todonotes definieren
\newcommand{\todoil}[2][{}]{\todo[linecolor=bblue,backgroundcolor=softblue,bordercolor=bblue,#1]{#2}}
\newcommand{\todolu}[2][{}]{\todo[linecolor=siepurple,backgroundcolor=softpurple,bordercolor=siepurple,#1]{#2}}
\newcommand{\todofl}[2][{}]{\todo[linecolor=dyellow,backgroundcolor=yellow,bordercolor=dyellow,#1]{#2}}
\newcommand{\todomi}[2][{}]{\todo[linecolor=dsand,backgroundcolor=ssand,bordercolor=dsand,#1]{#2}}
...
\hypersetup{
    pdfinfo={
        ...
        Author={\myAutor {,} \myAutorzwei {,} \myAutordrei {,} \myAutorvier},
        Build=1.1
    }
}
\else
...
\hypersetup{
    pdfinfo={
        Title={\myTitel},
        Subject={\myStudiengang},
        Author={\myAutor {,} \myAutorzwei {,} \myAutordrei},
        Build=1.1
    }
}
\else
...
% Titlepage
%-----------------------------------
\input{kapitel/titelseiteHausarbeit}
