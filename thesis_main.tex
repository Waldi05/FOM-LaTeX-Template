...
% Autoren im Anhang auflisten
\usepackage{etoc}
\usepackage{xparse}

% Autoren speichern
\newcounter{authrow}
\NewDocumentCommand{\authorentry}{m}{%
  \expandafter\gdef\csname auth@\theauthrow\endcsname{#1}%
  \stepcounter{authrow}%
}
\newcounter{authprint}

% Autorliste drucken
\newcommand{\printauthlist}{%
  \setcounter{authprint}{0}
  \etocsettocstyle{}{}

  \etocsetstyle{section}
    {}{}{%
      \stepcounter{authprint}%
      \etocnumber\quad
      \etocname\dotfill
      \csname auth@\theauthprint\endcsname\par
    }{}
  \etocsetstyle{subsection}
    {}{}{%
      \stepcounter{authprint}%
      \hspace{2em}% indent subsections
      \etocnumber\quad
      \etocname\dotfill
      \csname auth@\theauthprint\endcsname\par
    }{}
